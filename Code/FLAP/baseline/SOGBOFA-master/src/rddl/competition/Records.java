...
public class Records {
	...
	public boolean fileAppend(String fileName, String context, boolean replaceOld, String dataDir)
	{
		try {
			System.out.println("file name: " + fileName);


			String absPath = System.getProperty("user.dir")+"/run-data"+"/"+dataDir;
    ...
    public boolean fileAppend(String fileName, String context, boolean replaceOld)
    {
        try {
            ...
            String absPath = System.getProperty("user.dir")+"/run-data";
            System.out.println(absPath);
            File file = new File(absPath + System.getProperties().getProperty("file.separator") + fileName);
            if(replaceOld && file.exists()){
                file.delete();
