...
public class Server implements Runnable {
    ...
    private static long DEFAULT_TIME_ALLOWED = 3000000; // milliseconds = 18 minutes
...
//                    state.resetInterm();
                    ...
                    //		System.out.print("check1 :" + aa + ": " + state._observ.get(pn).get(aa));
                    //	}
                    //}
...
//            //add by yi
//            addOneText(dom, rootEle, "step-time-allowed", 500 + "");
            return Client.serialize(dom);
        } catch (Exception e) {
            System.out.println(e);
            return null;
