...
public class RDDL implements java.io.Serializable {
    ...
    public abstract static class TYPE_DEF implements java.io.Serializable {
    ...
    public abstract static class PVARIABLE_DEF implements java.io.Serializable {
...
//			}
    ...
    public static class CPF_HEADER_NAME {
        public CPF_HEADER_NAME(String s) {
            _sName = s;
        }
    ...
    public static class CPF_DEF implements java.io.Serializable {
    ...
    public static abstract class LTERM extends EXPR implements java.io.Serializable {
    ...
    public abstract static class LCONST extends LTERM implements java.io.Serializable {
    ...
    // Immutable... making public to avoid unnecessary
    // method calls, relying on user to respect immutability
    public static class TYPE_NAME implements java.io.Serializable {
    ...
    // Immutable... making public to avoid unnecessary
    // method calls, relying on user to respect immutability
    public static class OBJECT_VAL extends LCONST implements java.io.Serializable {
    ...
    // Immutable... making public to avoid unnecessary
    // method calls, relying on user to respect immutability
    public static class PVAR_NAME implements Comparable, java.io.Serializable {
    ...
    public static abstract class EXPR implements java.io.Serializable {
    ...
    public static class Discrete extends EXPR {
        ...
        public Object sample(HashMap<LVAR, LCONST> subs, State s, RandomDataGenerator r) throws EvalException {
            // 计算状态转移；
            // 列出状态的各种可能的后继状态和概率，并使用随机数计算后继状态；
            // 可以复制一个本函数单独计算后继状态的概率趋向，对规划产生正向作用；
            try {
        ...
        //add function to find succeed state probability by yi
        public ArrayList<Double> getProb(HashMap<LVAR, LCONST> subs, State s, RandomDataGenerator r) throws EvalException {
            try {
                LCONST_TYPE_DEF etd = null;
    ...
    public static class PVAR_EXPR extends BOOL_EXPR implements java.io.Serializable {
    ...
    public static class OBJECTS_DEF implements java.io.Serializable {
    ...
    public static class PVAR_INST_DEF implements java.io.Serializable {
