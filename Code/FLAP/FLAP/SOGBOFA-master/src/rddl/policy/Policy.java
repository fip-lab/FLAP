...
public abstract class Policy {
	...
	public Double Fitness(State s, Long timeLimit, int searchdeep) {
		System.out.println("return null ");
		return 0.0;
	}
	public Double StateFitness(State s, ArrayList<PVAR_INST_DEF> action, Long timeLimit, int actionNum, int searchdeep) {
		System.out.println("return null ");
		return 0.0;
	}
